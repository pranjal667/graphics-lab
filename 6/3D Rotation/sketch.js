...
function rotate3d(shape, about, degree){
    ...
    shape.forEach(element => {
        ...
        const x = p[0] * matrix[0][0] + p[1] * matrix[0][1] + p[2] * matrix[0][2] + p[3] * matrix[0][3];
  
        const y = p[0] * matrix[1][0] +  p[1] * matrix[1][1] +  p[2] * matrix[1][2] +  p[3] * matrix[1][3];
  
        const z =  p[0] * matrix[2][0] +  p[1] * matrix[2][1] +  p[2] * matrix[2][2] +  p[3] * matrix[2][3];
